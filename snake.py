...
serialDevFile = '/dev/cu.usbmodem14301'
...
while True:
    ...
    command = line[2]
    lastCommand = ''
    if command == 'u' and lastCommand != 'u':
        go_up()
        lastCommand = 'u'
    if command == 'd' and lastCommand != 'd':
        go_down()
        lastCommand = 'd'
    if command == 'r' and lastCommand != 'r':
        go_right()
        lastCommand = 'r'
    if command == 'l' and lastCommand != 'l':
        go_left()
        lastCommand = 'l'
